                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered table-md">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="#" class="btn btn-danger delete-btn" data-url="{{ route('program.destroy', $program->id) }}">
    ...
    <div class="modal-content">
        ...
        <div class="modal-body">
            <form action="{{ route('program.store') }}" method="POST" >
                ...
                <div class="form-group">
                    <label>Slug *</label>
                    <input id="slug" name="slug" type="text" value="" class="form-control" required readonly>
                </div>
