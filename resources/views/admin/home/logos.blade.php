                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            <table class="table table-bordered table-md">
                                ...
                                <tr>
                                    <td>{{ $a }}</td>
                                    <td><img style="width:10%;" src="{{ asset('images/logos/' . $img->image_path) }}" alt=""></td>
                                    <td>
                                        <a href="#" class="btn btn-danger delete-btn" data-url="{{ route('admin.logo.destroy', $img->id) }}">
