...
@section('title') Dashboard | Academic Partnership @endsection
        ...
        <div class="row">
            <div class="col-12 col-md-6 col-lg-6">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{ route('partnership.update', $data->id) }}" method="POST">
                            @csrf
                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            <table class="table table-bordered table-md">
                                ...
                                <tr>
                                    <td>{{ $a }}</td>
                                    <td><img style="width:50%;" src="{{ asset('images/partnership/' . $img->logo) }}" alt=""></td>
                                    <td>{{ $img->title }}</td>
                                    <td>
                                        ...
                                        <a href="#" class="btn btn-danger delete-btn" data-url="{{ route('admin.partnership.destroy', $img->id) }}"><i class="fas fa-trash-alt"></i></a>
                                    </td>
                                </tr>
                                @php $a++; @endphp
                                @endforeach
                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            <table class="table table-bordered table-md">
                                ...
                                <tr>
                                    <td>{{ $a }}</td>
                                    <td><img style="width:10%;" src="{{ asset('images/PartnershipLogos/' . $img->path) }}" alt=""></td>
                                    <td>
                                        <a href="#" class="btn btn-danger delete-btn2" data-url="{{ route('partnership.image.destroy', $img->id) }}"><i class="fas fa-trash-alt"></i></a>
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="formModal">Academic Partnership</h5>
...
<div class="modal fade" id="editModal" tabindex="-1" role="dialog" aria-labelledby="editModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                    <form action="{{ route('admin.partnership.content.update') }}" method="POST" enctype="multipart/form-data">
                        @csrf
...
<script>
    function uploadImage() {
        ...
        fetch("{{ route('partnership.image.upload') }}", {
            method: "POST",
            body: formData
        })
            ...
            button.addEventListener("click", function (e) {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        ...
                        .then(data => {
                            if (data.success) {
                                Swal.fire("Deleted!", "Academic Partnership has been deleted.", "success")
            ...
            button.addEventListener("click", function (e) {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        ...
                        .then(data => {
                            if (data.success) {
                                Swal.fire("Deleted!", "Logo has been deleted.", "success")
                                    .then(() => location.reload());
                            } else {
                                Swal.fire("Error!", data.message || "Something went wrong.", "error");
                            }
